...
class PastebinCrawler:
    ...
    def run(self) -> None:
        ...
        while True:
            ...
            interval = self.config.get("interval", 120)
    ...
    def crawl(self) -> List[Dict]:
        ...
        paste_sidebar = tree.xpath('//ul[@class="sidebar__menu"]')[0]

        # getting the link element
        links = paste_sidebar.xpath(".//a")
        ...
        for link in links:
            ...
            exising_paste = db.count_by_id(paste_id) > 0
            ...
            paste.set_content(requests.get(raw_url).text.strip())
